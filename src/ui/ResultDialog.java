...
public class ResultDialog extends JDialog {
    ...
    public ResultDialog(Frame owner, String status, int score, int time, int turns) {
        ...
        gbc.gridy = 0; gbc.insets = new Insets(10, 0, 20, 0);
        content.add(lblStatus, gbc);

        String stats = String.format(
            "<html><div style='text-align: center; font-family: SansSerif; font-size: 13pt; color: #333;'>"
            + "⭐ Điểm: <b style='color:#2980b9'>%d</b><br><br>"
            + "🕒 Thời gian: <b>%ds</b><br><br>"
            + "🎯 Số lượt: <b>%d</b>"
            + "</div></html>", score, time, turns
        );
        ...
        JButton btnRetry = createBtn("CHƠI LẠI", new Color(70, 130, 180), Color.WHITE);
        JButton btnMenu = createBtn("VỀ MENU", Color.WHITE, Color.BLACK);
